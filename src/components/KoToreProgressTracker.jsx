...
const KoToreProgressTracker = ({ styles, GAS_URL, API_KEY, assignedSchools = [], profileSource = 'kotore-progress' }) => {
            ...
            <tbody>
              {tableData.matrix.map((row, i) => (
                <tr key={i} style={{ height: '40px' }}>
                  ...
                  <td style={stickyColName}><StudentProfileLink userId={row.userId} source={profileSource}>{row.name}</StudentProfileLink></td>
