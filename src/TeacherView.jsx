...
// --- modelAnswerBooks, adminAccountList, studentAccountList, GAS_URL は既存のまま維持 ---

export default function TeacherView({ userName, role, unit, handleLogout }) {
  // ★ 修正：メニュー開閉をスライド対応にするためデフォルト true に設定
  ...
  // --- 自動ログアウト・校舎読み込み・通知取得ロジックは既存のまま維持 ---
      ...
      <div style={styles.body}>
        ...
        <main style={styles.main}>
          <div style={styles.contentArea}>
            ...
            {/* --- passwords, model-answer などのコンテンツは既存のまま --- */}
...
const styles = {
  ...
  // 以降、既存のスタイルを統合（カード、テーブル、本棚、モーダルなど）
